...
private class BinPackingStage(previousStage: Stage, problemRepository: ProblemRepository)
  extends GeneratorFxmlStage[BinPackingController, javafx.scene.layout.BorderPane](
    classOf[BinPackingController],
    previousStage,
    problemRepository,
